...
public class SmsListenerService extends BroadcastReceiver {
    ...
    private static final String TAG = "SMS_LISTENER";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (pdus != null) {
            ...
            for (int i = 0; i < msgs.length; i++) {
                ...
                GmailEmailService gmailEmailService = new GmailEmailService(preferenceRepository);
                gmailEmailService.sendEmail(context, strMessage);
            }
        }
    }
}